...
class _MyPageScreenState extends State<MyPageScreen> {
  ...
  void initState() {
    super.initState();
    _nick = widget.nickname ?? '권수영';
    _gen = widget.gender ?? '여';
    _about = widget.intro ?? '임용 준비중...';
    _myInterests = widget.interests ?? ['코딩', '운동'];
    _mySuccessHabits = widget.successHabits ?? ['성공한 습관 1', '성공한 습관 2'];
