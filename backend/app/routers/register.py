...
class Register(object):
    # 회원가입 시 사용하는 유저의 정보
    def __init__(self, phone: str, password: str, nickname: str, gender: Optional[str] = None, age: Optional[int] = None):
        self.__phone = phone
    ...
    def register_user(self):
        ...
        try:
            ...
            {self.__age}, {self.__bio}, {self.__profile_picture}, {self.__hb_balance}, {self.__created_at})"""
